...
# Input Form and each cateogory detailed
...
if submit:
    ...
    meaning = cluster_meaning.get(cluster, "Unknown category")

    # Distances (optional but useful)
    ...
    st.markdown(
        ...
        <div class="result-card">
            ...
            <h3>Meaning: <span style="color:{light_purple};">{meaning}</span></h3>
        </div>
        """,
        unsafe_allow_html=True
    )
